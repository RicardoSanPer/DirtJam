...
void VulkanApp::createFrameBuffers()
{
	...
	for (size_t i = 0; i < swapChainImageViews.size(); i++)
	{
		...
		framebufferInfo.pAttachments = attachments.data();	//ImageViews that should be attached to the respective attachment descriptions
...
void VulkanApp::createTextureImage()
{
	...
	stbi_uc* pixels = stbi_load("Images/Noise.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
void VulkanApp::generateMipmaps(VkImage image, VkFormat imageFormat, uint32_t texWidth, uint32_t texHeight, uint32_t mipLevels)
{
	...
	{
		throw std::runtime_error("Texture imge format does not support linear bittling");
	}
	...
	for (int i = 1; i < mipLevels; i++)
	{
		...
		vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_VERTEX_SHADER_BIT,
	...
	vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_VERTEX_SHADER_BIT, 0, 0, nullptr, 0, nullptr, 1, &barrier);
